...
export default function AboutSection() {
  ...
  return (
    <section id="about" ref={ref} className="py-16 md:py-24 lg:py-32" data-testid="section-about">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        >
          ...
          <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
            A dedicated engineering student with a passion for innovation, problem-solving, and creating impactful
            solutions
          </p>
        </div>
            ...
            <Card className="p-6 md:p-8 backdrop-blur-md bg-card/80 border-card-border hover-elevate">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-muted-foreground">
                    <span className="text-foreground font-medium">400+ problems</span> solved on LeetCode, GFG,
                    Codeforces
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-muted-foreground">
                    <span className="text-foreground font-medium">She Codes Scholar</span> - Selected based on academics
                    & coding proficiency
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    <span className="text-foreground font-medium">Cisco Certified</span> in Introduction to
                    Cybersecurity
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-accent mt-2 flex-shrink-0" />
                  <p className="text-muted-foreground">
                    <span className="text-foreground font-medium">NPTEL Certified</span> in Innovation, Business &
                    Design Thinking
                  </p>
                </div>
              </div>
