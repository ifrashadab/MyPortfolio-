...
export default function ExperienceSection() {
  ...
  const experiences = [
    {
      ...
      description:
        "Completed 5 C++ projects, gaining hands-on experience in problem-solving, debugging, and development",
      color: "text-primary",
    ...
    },
    {
      ...
      period: "Ongoing",
      description:
        "Assisted at polling booths, attended seminars (e.g., Project Life – IIT Delhi), and conducted career sessions in government schools",
      color: "text-accent",
  ...
  return (
    <section id="experience" ref={ref} className="py-16 md:py-24 lg:py-32" data-testid="section-experience">
              ...
              >
                <Card className="p-6 md:p-8 backdrop-blur-md bg-card/80 border-card-border hover-elevate overflow-visible">
                  <div className="flex flex-col md:flex-row gap-6">
                    <div
                      className={`w-16 h-16 rounded-full ${experience.bgColor} flex items-center justify-center flex-shrink-0`}
                    >
                      <Icon className={`h-8 w-8 ${experience.color}`} />
                    </div>
                    <div className="flex-1">
                      <h3 className="text-xl font-heading font-semibold mb-1">{experience.role}</h3>
