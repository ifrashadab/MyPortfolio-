...
export default function ContactSection() {
  ...
  return (
    <section id="contact" ref={ref} className="py-16 md:py-24 lg:py-32 bg-muted/30" data-testid="section-contact">
          ...
          <Card className="p-8 md:p-12 backdrop-blur-md bg-card/80 border-card-border text-center">
            <div className="space-y-8">
                ...
                {socialLinks.map((link, index) => {
                  ...
                  return (
                    ...
                    >
                      <Button
                        variant="outline"
                        className="w-full h-auto flex flex-col items-center gap-3 py-6 hover-elevate active-elevate-2 group overflow-visible bg-transparent"
              ...
              <div className="pt-6 border-t border-border">
                <p className="text-muted-foreground mb-4">Email: ifra.shadab.ug23@nsut.ac.in</p>
                <p className="text-muted-foreground">Phone: +91 9289658878</p>
              </div>
            </div>
          </Card>
        </div>
