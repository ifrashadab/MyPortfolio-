...
export default function AchievementsSection() {
  ...
  const achievements = [
    ...
    },
    {
      ...
      description:
        "Introduction to Cybersecurity certification. Gained foundational knowledge in online threats, security principles, cryptography, and cyber defense",
      color: "text-accent",
    ...
    },
    {
      ...
      description:
        "Selected among highly competitive applicants based on academic performance, coding proficiency, and community involvement",
    ...
    },
    {
      ...
      description:
        "400+ problems solved on LeetCode, GeeksforGeeks, and Codeforces across data structures and algorithms",
      color: "text-primary",
      bgColor: "bg-primary/10",
    },
    {
      ...
      description:
        "Certification in Innovation, Business, and Entrepreneurship. Gained insights into market dynamics, start-up ecosystem, and business model innovation",
      color: "text-accent",
      bgColor: "bg-accent/10",
    },
    {
      ...
      description:
        "Achieved 80 percentile, showcasing proficiency in user-centred innovation, problem-solving frameworks, and creative ideation techniques",
      color: "text-secondary",
      bgColor: "bg-secondary/10",
    },
  ]
            ...
            return (
              ...
              >
                <Card className="h-full p-6 backdrop-blur-md bg-card/80 border-card-border hover-elevate group overflow-visible">
                  <div
                    className={`w-12 h-12 rounded-full ${achievement.bgColor} flex items-center justify-center mb-4`}
                  >
