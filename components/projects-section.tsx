...
export default function ProjectsSection() {
  ...
  const projects = [
    {
      title: "E-Nirikshan",
      description:
        "E-Nirakshan App is an online productivity monitoring tool designed for government offices to enhance efficiency and engagement. It helps set goals, track progress, and evaluate performance at organizational, team, and individual levels. The app bridges the management gap under the e-Office platform, fostering measurable productivity improvement.",
    ...
    },
    {
      title: "SafeTrail",
      description:
        "Built an application with an AI chatbot, danger zone alerts, and lost & found system to enhance safety and convenience for tourists in Northeast India",
    ...
    },
    {
      ...
      description:
        "Built a real-time community-driven SOS app with AI medical chatbot (Python, NLP), reducing average response time by 40%. Integrated secure coding practices & REST APIs for real-time alerts and volunteer matching",
  ...
  return (
    <section id="projects" ref={ref} className="py-16 md:py-24 lg:py-32" data-testid="section-projects">
